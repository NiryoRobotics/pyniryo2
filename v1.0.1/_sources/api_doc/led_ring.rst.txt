...
This file presents the different :ref:`functions <api_doc/led_ring:Led Ring - Command functions>`,
:ref:`enums <api_doc/led_ring:Led Ring - Enums>`,
:ref:`topics <api_doc/led_ring:Led Ring - Niryo Topics>` and
:ref:`objects <api_doc/led_ring:Led Ring - Objects>` available with the Led Ring API
...
All functions are accessible via an instance of the class :ref:`NiryoRobot <api_doc/niryo_robot:NiryoRobot>` ::
...
The use of these functions is explained in the :ref:`NiryoTopics <api_doc/niryo_topics:NiryoTopic>`, section.
