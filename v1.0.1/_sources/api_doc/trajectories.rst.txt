...
This file presents the different :ref:`api_doc/trajectories:Trajectories - Command functions` available with the Trajectories API
...
See examples on :ref:`Examples Section <examples/examples_movement:Examples: Movement>`
